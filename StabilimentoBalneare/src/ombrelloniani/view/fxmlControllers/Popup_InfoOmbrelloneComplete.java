...
public class Popup_InfoOmbrelloneComplete extends VBox {
	...
	public Popup_InfoOmbrelloneComplete(String[] content) {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/ombrelloniani/view/fxml/Popup_InfoOmbrelloneComplete.fxml"));
			loader.setRoot(this);
